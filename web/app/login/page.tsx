  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-atlas-bg">
      <div className="w-full max-w-sm mx-4">
        <div className="bg-atlas-card border border-atlas-border rounded-2xl p-8 shadow-xl">
          {/* Logo */}
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white tracking-tight">ATLAS</h1>
            <p className="text-sm text-atlas-muted mt-2">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl
                         ...
                         hover:bg-[#2f363d] transition-colors border border-gray-600
                         disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {/* Divider */}
          <div className="mt-6 pt-6 border-t border-atlas-border">
            <p className="text-xs text-atlas-muted text-center">
              4 LLMs x 2 Architectures x 10 Global Markets
            </p>
          </div>
        </div>
      </div>
